...
CREATE OR ALTER PROCEDURE test_static_data.test_subject_data_type__data
AS
BEGIN
    ...
    SELECT  t.subject_data_type_id
           ,t.subject_data_type_desc
           ,t.subject_data_type_translation_key
    INTO    #actual
    FROM    privacy_framework.subject_data_type AS t;
 
    EXEC tSQLt.AssertEqualsTable @Expected = N'#expected'
                                ,@Actual = N'#actual'
                                ,@Message = N'subject_data_type data not as expected';
