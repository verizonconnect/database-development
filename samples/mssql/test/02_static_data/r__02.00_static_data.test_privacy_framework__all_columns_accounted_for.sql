...
CREATE OR ALTER PROCEDURE test_static_data.test_privacy_framework__all_columns_accounted_for
AS
BEGIN
    ...
    EXEC tSQLt.AssertEqualsTable @Expected = N'#expected'
                                ,@Actual = N'#actual'
                                ,@Message = N'privacy_framework.column_data_dictionary data does not match the schema';
END;
GO
