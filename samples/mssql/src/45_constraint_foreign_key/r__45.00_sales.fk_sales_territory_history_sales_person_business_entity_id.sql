...
IF OBJECT_ID('[sales].[fk_sales_territory_history_sales_person_business_entity_id]', 'F') IS NULL
BEGIN
...
ALTER TABLE [sales].[sales_territory_history] 
CHECK CONSTRAINT [fk_sales_territory_history_sales_person_business_entity_id];
GO
...
IF NOT EXISTS (SELECT 1 
               FROM sys.fn_listextendedproperty(N'MS_Description'
                                              ...
                                              , N'CONSTRAINT',N'fk_sales_territory_history_sales_person_business_entity_id'))
    EXEC sys.sp_addextendedproperty @name=N'MS_Description'
                                  ...
                                  , @level2type=N'CONSTRAINT',@level2name=N'fk_sales_territory_history_sales_person_business_entity_id'
GO
