...
IF OBJECT_ID('[purchasing].[df_purchase_order_header_tax_amt]', 'D') IS NULL
    BEGIN
        ALTER TABLE [purchasing].[purchase_order_header]
        ADD CONSTRAINT [df_purchase_order_header_tax_amt]
        DEFAULT ((0.00))
        FOR [tax_amt];
    END;
GO
...
IF NOT EXISTS (SELECT 1 
               FROM sys.fn_listextendedproperty(N'MS_Description'
                                              ...
                                              , N'CONSTRAINT',N'df_purchase_order_header_tax_amt'))
    EXEC sys.sp_addextendedproperty @name=N'MS_Description'
                                  ...
                                  , @level2type=N'CONSTRAINT',@level2name=N'df_purchase_order_header_tax_amt'
GO
