...
GO
IF NOT EXISTS (SELECT 1 FROM sys.views WHERE object_id = OBJECT_ID(N'[human_resources].[job_candidate_resume]'))
EXEC sys.sp_executesql @statement = N'
CREATE VIEW [human_resources].[job_candidate_resume] 
AS 
SELECT 
    jc.[job_candidate_id] 
