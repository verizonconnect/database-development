...
IF OBJECT_ID('[production].[ck_product_cost_history_end_date]', 'C') IS NULL
    BEGIN
...
ALTER TABLE [production].[product_cost_history] 
CHECK CONSTRAINT [ck_product_cost_history_end_date]
GO
...
IF NOT EXISTS (SELECT 1 
               FROM sys.fn_listextendedproperty(N'MS_Description'
                                              ...
                                              , N'CONSTRAINT',N'ck_product_cost_history_end_date'))
    EXEC sys.sp_addextendedproperty @name=N'MS_Description'
                                  ...
                                  , @level2type=N'CONSTRAINT',@level2name=N'ck_product_cost_history_end_date'
GO
