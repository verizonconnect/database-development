CREATE OR REPLACE FUNCTION production.get_bill_of_materials (
...
BEGIN
    RETURN QUERY
        WITH RECURSIVE bom_cte AS (
            ...
            WHERE   b.product_assembly_id = v_start_product_id
...
COMMENT ON FUNCTION production.get_bill_of_materials(INT, TIMESTAMP) IS 'Returns a multi-level bill of material for the specified product_id.';
