...
IF OBJECT_ID('[purchasing].[df_ship_method_rowguid]', 'D') IS NULL
    BEGIN
        ALTER TABLE [purchasing].[ship_method]
        ADD CONSTRAINT [df_ship_method_rowguid]
        DEFAULT (newid())
        FOR [rowguid];
    END;
GO
...
IF NOT EXISTS (SELECT 1 
               FROM sys.fn_listextendedproperty(N'MS_Description'
                                              ...
                                              , N'CONSTRAINT',N'df_ship_method_rowguid'))
    EXEC sys.sp_addextendedproperty @name=N'MS_Description'
                                  ...
                                  , @level2type=N'CONSTRAINT',@level2name=N'df_ship_method_rowguid'
GO
