...
IF OBJECT_ID('[purchasing].[fk_purchase_order_header_ship_method_ship_method_id]', 'F') IS NULL
BEGIN
...
ALTER TABLE [purchasing].[purchase_order_header] 
CHECK CONSTRAINT [fk_purchase_order_header_ship_method_ship_method_id];
GO
...
IF NOT EXISTS (SELECT 1 
               FROM sys.fn_listextendedproperty(N'MS_Description'
                                              ...
                                              , N'CONSTRAINT',N'fk_purchase_order_header_ship_method_ship_method_id'))
    EXEC sys.sp_addextendedproperty @name=N'MS_Description'
                                  ...
                                  , @level2type=N'CONSTRAINT',@level2name=N'fk_purchase_order_header_ship_method_ship_method_id'
GO
