...
IF OBJECT_ID('[production].[fk_product_product_photo_product_product_id]', 'F') IS NULL
BEGIN
...
ALTER TABLE [production].[product_product_photo] 
CHECK CONSTRAINT [fk_product_product_photo_product_product_id];
GO
...
IF NOT EXISTS (SELECT 1 
               FROM sys.fn_listextendedproperty(N'MS_Description'
                                              ...
                                              , N'CONSTRAINT',N'fk_product_product_photo_product_product_id'))
    EXEC sys.sp_addextendedproperty @name=N'MS_Description'
                                  ...
                                  , @level2type=N'CONSTRAINT',@level2name=N'fk_product_product_photo_product_product_id'
GO
