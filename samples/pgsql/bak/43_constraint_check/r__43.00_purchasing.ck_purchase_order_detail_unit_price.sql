...
IF OBJECT_ID('[purchasing].[ck_purchase_order_detail_unit_price]', 'C') IS NULL
    BEGIN
...
ALTER TABLE [purchasing].[purchase_order_detail] 
CHECK CONSTRAINT [ck_purchase_order_detail_unit_price]
GO
...
IF NOT EXISTS (SELECT 1 
               FROM sys.fn_listextendedproperty(N'MS_Description'
                                              ...
                                              , N'CONSTRAINT',N'ck_purchase_order_detail_unit_price'))
    EXEC sys.sp_addextendedproperty @name=N'MS_Description'
                                  ...
                                  , @level2type=N'CONSTRAINT',@level2name=N'ck_purchase_order_detail_unit_price'
GO
