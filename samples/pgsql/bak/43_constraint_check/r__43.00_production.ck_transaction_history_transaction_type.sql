...
IF OBJECT_ID('[production].[ck_transaction_history_transaction_type]', 'C') IS NULL
    BEGIN
...
ALTER TABLE [production].[transaction_history] 
CHECK CONSTRAINT [ck_transaction_history_transaction_type]
GO
...
IF NOT EXISTS (SELECT 1 
               FROM sys.fn_listextendedproperty(N'MS_Description'
                                              ...
                                              , N'CONSTRAINT',N'ck_transaction_history_transaction_type'))
    EXEC sys.sp_addextendedproperty @name=N'MS_Description'
                                  ...
                                  , @level2type=N'CONSTRAINT',@level2name=N'ck_transaction_history_transaction_type'
GO
