...
GO
CREATE OR ALTER TRIGGER [purchasing].[u_purchase_order_detail] ON [purchasing].[purchase_order_detail] 
AFTER UPDATE AS 
BEGIN
    DECLARE @Count int;
