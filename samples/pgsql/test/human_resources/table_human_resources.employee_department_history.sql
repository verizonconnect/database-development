...
SELECT col_default_is(   'human_resources', 'employee_department_history', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column human_resources.employee_department_history.modified_date default is');
