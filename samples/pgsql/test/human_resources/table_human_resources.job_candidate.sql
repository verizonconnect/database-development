...
SELECT col_default_is(   'human_resources', 'job_candidate', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column human_resources.job_candidate.modified_date default is');
