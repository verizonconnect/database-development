...
SELECT col_is_pk('person'::name, 'state_province'::name, ARRAY[
...
SELECT col_default_is(   'person', 'state_province', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column person.state_province.modified_date default is');
