...
SELECT col_is_pk('person'::name, 'address'::name, ARRAY[
    'address_id'::name
],
...
SELECT col_default_is(   'person', 'address', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column person.address.modified_date default is');
