...
SELECT col_is_pk('person'::name, 'contact_type'::name, ARRAY[
...
SELECT col_default_is(   'person', 'contact_type', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column person.contact_type.modified_date default is');
