...
SELECT col_default_is(   'purchasing', 'purchase_order_detail', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column purchasing.purchase_order_detail.modified_date default is');
