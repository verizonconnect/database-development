...
SELECT col_default_is(   'production', 'product_description', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column production.product_description.modified_date default is');
