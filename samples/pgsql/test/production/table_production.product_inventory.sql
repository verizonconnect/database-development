...
SELECT col_default_is(   'production', 'product_inventory', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column production.product_inventory.modified_date default is');
