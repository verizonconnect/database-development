...
SELECT col_default_is(   'production', 'product_list_price_history', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column production.product_list_price_history.modified_date default is');
