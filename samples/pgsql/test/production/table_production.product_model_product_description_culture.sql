...
SELECT col_is_pk('production'::name, 'product_model_product_description_culture'::name, ARRAY[
...
SELECT col_default_is(   'production', 'product_model_product_description_culture', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column production.product_model_product_description_culture.modified_date default is');
