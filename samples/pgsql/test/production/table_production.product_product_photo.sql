...
SELECT col_is_pk('production'::name, 'product_product_photo'::name, ARRAY[
    'product_id'::name,
...
SELECT col_default_is(   'production', 'product_product_photo', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column production.product_product_photo.modified_date default is');
