...
SELECT col_is_pk('production'::name, 'product_model'::name, ARRAY[
...
SELECT col_default_is(   'production', 'product_model', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column production.product_model.modified_date default is');
