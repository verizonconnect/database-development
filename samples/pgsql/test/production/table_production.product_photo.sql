...
SELECT col_is_pk('production'::name, 'product_photo'::name, ARRAY[
...
SELECT col_default_is(   'production', 'product_photo', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column production.product_photo.modified_date default is');
