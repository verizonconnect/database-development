...
SELECT col_is_pk('production'::name, 'culture'::name, ARRAY[
    'culture_id'::name
],
...
SELECT col_default_is(   'production', 'culture', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column production.culture.modified_date default is');
