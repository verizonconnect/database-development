...
SELECT col_default_is(   'sales', 'sales_territory_history', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column sales.sales_territory_history.modified_date default is');
