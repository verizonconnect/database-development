...
SELECT col_is_pk('sales'::name, 'country_region_currency'::name, ARRAY[
...
SELECT col_default_is(   'sales', 'country_region_currency', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column sales.country_region_currency.modified_date default is');
