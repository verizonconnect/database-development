...
SELECT col_is_pk('sales'::name, 'customer'::name, ARRAY[
    'customer_id'::name
],
...
SELECT col_default_is(   'sales', 'customer', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column sales.customer.modified_date default is');
