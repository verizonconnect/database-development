...
SELECT has_check(
    'sales', 'sales_person',
    'Table sales.sales_person should have check contraint(s)'
);

SELECT col_is_pk('sales'::name, 'sales_person'::name, ARRAY[
...
SELECT col_has_check(    'sales', 'sales_person', 'sales_quota', 'Column sales.sales_person.sales_quota should have a check constraint');
...
SELECT col_has_check(    'sales', 'sales_person', 'bonus', 'Column sales.sales_person.bonus should have a check constraint');
...
SELECT col_has_check(    'sales', 'sales_person', 'commission_pct', 'Column sales.sales_person.commission_pct should have a check constraint');
...
SELECT col_has_check(    'sales', 'sales_person', 'sales_ytd', 'Column sales.sales_person.sales_ytd should have a check constraint');
...
SELECT col_has_check(    'sales', 'sales_person', 'sales_last_year', 'Column sales.sales_person.sales_last_year should have a check constraint');
...
SELECT col_default_is(   'sales', 'sales_person', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column sales.sales_person.modified_date default is');
