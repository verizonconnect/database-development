...
SELECT col_default_is(   'sales', 'sales_order_header', 'order_date', '(now() AT TIME ZONE ''utc''::text)', 'Column sales.sales_order_header.order_date default is');
...
SELECT col_default_is(   'sales', 'sales_order_header', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column sales.sales_order_header.modified_date default is');
