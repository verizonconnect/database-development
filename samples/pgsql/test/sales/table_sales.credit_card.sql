...
SELECT col_is_pk('sales'::name, 'credit_card'::name, ARRAY[
    'credit_card_id'::name
],
...
SELECT col_default_is(   'sales', 'credit_card', 'modified_date', '(now() AT TIME ZONE ''utc''::text)', 'Column sales.credit_card.modified_date default is');
